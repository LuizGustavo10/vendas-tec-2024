        ...
        <div class="row">
          <div class="col-md-4 card">
            ...
            <form action="<?=$destino?>" method="POST">
              ...
              <div class="form-group">
                <label> Estado </label>
                <input value="<?php echo isset($dadosAlteracao) ? $dadosAlteracao['estado'] : '' ?>" 
                type="text" name="estado" class="form-control" id="estado" placeholder="estado">
              </div>

              <div class="form-group">
                <label>cep</label>
                <input type="text" value="<?php echo isset($dadosAlteracao) ? $dadosAlteracao['cep'] : '' ?>" 
                                    name="cep" class="form-control cep" id="cep" placeholder="cep">
              </div>
